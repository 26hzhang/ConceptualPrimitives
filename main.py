...
from models.clustering import normalize_vectors, kmeans_clustering, compute_distance, compute_knearest
...
parser.add_argument("--use_ntn", type=boolean_string, default=True, help="use ntn to fuse left and right context")
parser.add_argument("--tune_emb", type=boolean_string, default=False, help="tune pre-trained embeddings while training")
parser.add_argument("--lr", type=float, default=0.002, help="learning rate")
parser.add_argument("--batch_size", type=int, default=200, help="batch size")
parser.add_argument("--epochs", type=int, default=10, help="number of epochs trained")
...
parser.add_argument("--glove_path",
                    type=str,
                    default=os.path.join(home, "utilities", "embeddings", "glove", "glove.42B.300d.txt"),
                    help="pre-trained embeddings")
...
parser.add_argument("--word_vectors", type=str, default="data/word_vectors.npz", help="pre-trained context emb")
parser.add_argument("--verb_vectors", type=str, default="data/verb_vectors.npz", help="pre-trained target emb")
...
if config.mode == "train":
    ...
    model.train(dataset=config.dataset)
